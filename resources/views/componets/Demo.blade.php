<div>
    ...
    <div class="w-11/12 flex flex-wrap my-4 space-y-4 md:space-x-4  justify-center ">
        ...
        <div
            ...
            <a href="#">
                <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">KenyaEMR 2.x</h5>
            </a>
            <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">Use this for KenyaEMR training and demo.</p>
            <ul class="list-inside p-2  hover:text-slate-700 dark:text-slate-300 dark:shadow-none dark:ring-0">
                <li>Login Username: <span class="select-all">Admin</span> </li>
                <li>Password: <span class="select-all">Admin123</span></li>
                <!-- ... -->
            </ul>

            <a href="https://data.kenyahmis.org:8500/openmrs" target="_blank"
            ...
            <a href="https://github.com/palladiumkenya/kenyahmis-releases/releases/tag/v26" target="_blank"
                class="inline-flex items-center py-2 px-3 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                Github
                <svg class="ml-2 -mr-1 w-4 h-4" fill="currentColor" viewBox="0 0 30 30"
                    xmlns="http://www.w3.org/2000/svg">
        ...
        <div
            class="p-6 max-w-sm bg-white  rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
            <a href="#">
                <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">KenyaEMR 1.x</h5>
            </a>
            <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">Use this for KenyaEMR training and demo.</p>
            <ul class="list-inside p-2  hover:text-slate-700 dark:text-slate-300 dark:shadow-none dark:ring-0">
                <li>Login Username: <span class="select-all">Admin</span> </li>
            ...
            <a href="https://data.kenyahmis.org:9100/openmrs/index.htm" target="_blank"
                class="inline-flex items-center py-2 px-3 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                KenyaEMR v1.X
                <svg class="ml-2 -mr-1 w-4 h-4" fill="currentColor" viewBox="0 0 30 30"
                    xmlns="http://www.w3.org/2000/svg">
        ...
        <div
            class="p-6 max-w-sm bg-white  rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
            <a href="#">
                <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">SPOT</h5>
            </a>
            <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">Use this for SPOT training and
                testing.<span>EMR
                    metrics can also be viewed</span></p>
            <ul class="list-inside p-2 hover:text-slate-700 dark:text-slate-300 dark:shadow-none dark:ring-0">
                <li>Login Username: <span class="select-all">Not required</span> </li>
                <li>Password: <span class="select-all">Not required</span></li>
                <!-- ... -->
            </ul>

            <a href="https://spotstaging.kenyahmis.org/" target="_blank"
                class="inline-flex items-center py-2 px-3 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                SPOT
                <svg class="ml-2 -mr-1 w-4 h-4" fill="currentColor" viewBox="0 0 30 30"
                    xmlns="http://www.w3.org/2000/svg">
            ...
            <a href="https://github.com/palladiumkenya/spot" target="_blank"
                class="inline-flex items-center py-2 px-3 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                Github
                <svg class="ml-2 -mr-1 w-4 h-4" fill="currentColor" viewBox="0 0 30 30"
                    xmlns="http://www.w3.org/2000/svg">
        ...
        <div
            class="p-6 max-w-sm bg-white  rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
            <a href="#">
                <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Ushauri</h5>
            </a>
            <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">Use this for Ushauri training and demo. To
                install,
                get latest</p>
            <ul class="list-inside p-2 hover:text-slate-700 dark:text-slate-300 dark:shadow-none dark:ring-0">
            ...
            <a href="http://176.58.109.44:5020/" target="_blank"
                class="inline-flex items-center py-2 px-3 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                Ushauri
                <svg class="ml-2 -mr-1 w-4 h-4" fill="currentColor" viewBox="0 0 30 30"
                    xmlns="http://www.w3.org/2000/svg">
            ...
            <a href="https://github.com/palladiumkenya/ushauriweb" target="_blank"
                class="inline-flex items-center py-2 px-3 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                Github
                <svg class="ml-2 -mr-1 w-4 h-4" fill="currentColor" viewBox="0 0 30 30"
                    xmlns="http://www.w3.org/2000/svg">
        ...
        <div
            class="p-6 max-w-sm bg-white  rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
            <a href="#">
                <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Interoperability Layer
                </h5>
            </a>
            <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">Use this for IL training and demo. To install,
                get
                latest.</p>
            <ul class="list-inside p-2 hover:text-slate-700 dark:text-slate-300 dark:shadow-none dark:ring-0">
                <li>Login Username: <span class="select-all">admin</span> </li>
                <li>Password: <span class="select-all">admin</span></li>
                <!-- ... -->
            </ul>

            <a href="https://il.kenyahmis.org" target="_blank"
                class="inline-flex items-center py-2 px-3 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                I.L
                <svg class="ml-2 -mr-1 w-4 h-4" fill="currentColor" viewBox="0 0 30 30"
                    xmlns="http://www.w3.org/2000/svg">
            ...
            <a href="https://github.com/palladiumkenya/Interoperability-Layer/releases/tag/1.0.0" target="_blank"
                class="inline-flex items-center py-2 px-3 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                Github
                <svg class="ml-2 -mr-1 w-4 h-4" fill="currentColor" viewBox="0 0 30 30"
                    xmlns="http://www.w3.org/2000/svg">

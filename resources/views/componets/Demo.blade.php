...
<section class="bg-white dark:bg-gray-900 my-6 grid-cols-4">
 {{-- prod servers --}}
    <div>
            ...
            <div class="bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 h-100">
                <div class="flex justify-end px-4 pt-2">
                    ...
                    <div id="dropdown" class="z-10 hidden text-base list-none bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700">
                        ...
                        <li>
                            <a href="{{ route('prod.edit', $item->id)}}" target="_blank" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">Edit</a>
                        </li>
                        <li>
...
{{--            @foreach ($prod                    Data as $item)--}}

{{--            <!-- kenyaemr 18.x-->--}}
{{--            <div--}}
{{--                class="bg-white my-1 P-6 rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700 text-center">--}}
{{--                <a href="#">--}}
...
{{--                // print_r($out[0]);--}}
{{--        ?>--}}
{{--                <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">Live on <span class="font-bold ">{{$out[0]}}</span></p>--}}
...
{{--                    <li class="float-left"><a href="{{ route('prod.edit', $item->id)}}"><button type="button"--}}
...
{{--                <ul--}}
{{--                    class="list-inside font-sm p-2 hover:text-slate-700 dark:text-slate-300 dark:shadow-none dark:ring-0">--}}
